...
const ForgotPassword = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/api/counselors/password/forgot`, { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/api/counselors/password/verify-otp`, { email, otp });
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`http://localhost:5000/api/counselors/password/reset`, {
        email,
        newPassword,
        confirmPassword,
      });
